...
#ifndef NDEBUG
	{
		static unsigned long dumpTimeout = 0;
		if (dumpTimeout == 0 || (GetTickCount() - dumpTimeout) > 60L * 60000L) {
...
#define RETAILMSG(x, y) _tprintf y
#endif			
			printf("++++++++++++++++++++++++++++++++++\r\n");
			printf("Dump at %d/%d %d:%d:%d\r\n", nowST.wMonth, nowST.wDay, nowST.wHour, nowST.wMinute, nowST.wSecond);
			printf("MemLoad=%d,TotalPhys=%dK,AvailPhys=%dK\r\n", memState.dwMemoryLoad,memState.dwTotalPhys/1024,memState.dwAvailPhys/1024);
			printf("----------------------------------\r\n");
#endif
			
			dumpTimeout = GetTickCount();
		}
	}
#endif

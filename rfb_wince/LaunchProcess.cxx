...
void LaunchProcess::start(HANDLE userToken, bool createConsole) {
  ...
  DWORD flags = createConsole ? CREATE_NEW_CONSOLE : 0;
  BOOL success;
...
#ifdef _WIN32_WCE
  // The child process can create a event when it finish initiallisting
  // under Windows CE.Correspondingly, here just wait for this event.  
  await(15000);
#else  

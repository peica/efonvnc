...
#include <rfb_wince/LaunchProcess.h>
#include <rfb_wince/TrayIcon.h>
...
public:
  STrayIcon(STrayIconThread& t) : thread(t),
	vncConfig(_T("vncconfig.exe"), _T("-noconsole")),
    vncConnect(_T("efonvnc.exe"), _T("-noconsole -connect")) {
  ...
  virtual LRESULT processMessage(UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_USER:
      {
		bool allowOptions = !STrayIconThread::disableOptions;
        bool allowClose = !STrayIconThread::disableClose;
        ...
        case WM_LBUTTONDBLCLK:
          ...
          break;
        case WM_RBUTTONUP:
          HMENU menu = LoadMenu(gInst, MAKEINTRESOURCE(thread.menu));
          ...
          EnableMenuItem(trayMenu, ID_CONNECT, MF_ENABLED | MF_BYCOMMAND);
    ...
    case WM_COMMAND:
      ...
      case ID_OPTIONS:
        {
          // Note: Windows CE do not have the user token
